...
public class EditFlight2 extends JFrame {
	...
	public static void main(String[] args) {
		EditFlight2 frame = new EditFlight2("000");
		frame.setVisible(true);
	}
	public EditFlight2(String fid) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				else if (Integer.parseInt(economySeats.getText())>150)
				{
					JOptionPane.showMessageDialog(null, "Economy seats cannot be greater than 150");
				}
				else if (Integer.parseInt(businessSeats.getText())>50)
				{
					JOptionPane.showMessageDialog(null, "Business seats cannot be greater than 40");
				}
				else
				{
